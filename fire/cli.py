...
# from
# https://github.com/GoogleCloudPlatform/appengine-mapreduce/blob/master/python/src/mapreduce/util.py#L175
...
def main():
  ...
  parser.add_argument('fq_name')
  args, remaining = parser.parse_known_args()
  fq_name = args.fq_name
  command = ' '.join(remaining)
  handler = for_name(fq_name)
  fire.Fire(handler, command)
